...
#CORPUS=text8
CORPUS=../vector/ContextRaw.txt
VOCAB_FILE=../vector/vocab.txt
COOCCURRENCE_FILE=../vector/cooccurrence.bin
COOCCURRENCE_SHUF_FILE=../vector/cooccurrence.shuf.bin
SAVE_FILE=../vector/vectors
VERBOSE=2
MEMORY=4.0
VOCAB_MIN_COUNT=5
VECTOR_SIZE=50
